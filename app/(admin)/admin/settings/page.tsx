			...
			<header className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-b border-white/5 pb-10">
				<div>
					...
					<h1 className="text-4xl lg:text-6xl font-black uppercase tracking-tighter text-[#F5F5F0]">
						Foundry <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FFB400] to-[#FF8C00]">Settings</span>
					</h1>
				</div>
				<div className="flex items-center gap-4 text-[#94A3B8] text-[9px] font-mono border border-white/5 px-4 py-2 bg-white/[0.01]">VERSION: BBL_CORE_v60.0.4</div>
			</header>
